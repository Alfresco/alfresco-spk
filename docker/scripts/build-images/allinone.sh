...
docker import - maoo/alfresco-allinone-community < alfresco-allinone-community.tar
rm *.tar
...
docker import - maoo/alfresco-allinone-enterprise < alfresco-allinone-enterprise.tar
rm *.tar
